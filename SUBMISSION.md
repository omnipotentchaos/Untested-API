...
## Bug Summary
I found and fixed 4 separate bugs in the codebase. Please refer to **[`BUG_REPORT.md`](./BUG_REPORT.md)** for a detailed analysis of the root causes and the specific lines changed.
